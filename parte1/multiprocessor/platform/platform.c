...
int main(int argc, char ** argv) {
    ...
    // start address)
    if(
        !icmLoadProcessorMemory(processor0, "C:/Users/andre/Desktop/SE/parte1/multiprocessor/application/application.OR1K.elf", False, False, True) ||
        !icmLoadProcessorMemory(processor1, "C:/Users/andre/Desktop/SE/parte1/multiprocessor/application/application.OR1K.elf", False, False, True) ||
        !icmLoadProcessorMemory(processor2, "C:/Users/andre/Desktop/SE/parte1/multiprocessor/application/application.OR1K.elf", False, False, True)
    ) {
        return -1;
    }
