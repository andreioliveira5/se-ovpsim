...
int main(int argc, char ** argv) {
    ...
    // start address)
    if(
        !icmLoadProcessorMemory(processor0, "C:/Users/PICHAU/Desktop/Faculdade/VIII_semestre/Sistemas_embarcados/OVP/Aula3/Atividade2/multiprocessor/application/application.OR1K.elf", False, False, True) ||
        !icmLoadProcessorMemory(processor1, "C:/Users/PICHAU/Desktop/Faculdade/VIII_semestre/Sistemas_embarcados/OVP/Aula3/Atividade2/multiprocessor/application/application.OR1K.elf", False, False, True) ||
        !icmLoadProcessorMemory(processor2, "C:/Users/PICHAU/Desktop/Faculdade/VIII_semestre/Sistemas_embarcados/OVP/Aula3/Atividade2/multiprocessor/application/application.OR1K.elf", False, False, True)
    ) {
        return -1;
    }
